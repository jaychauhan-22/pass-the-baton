                ...
                <div class="row">
                    <div class="col-md-3 border-right">
                        <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="rounded-circle mt-5"
                                                                                                     width="150px"
                                                                                                     src="assest/img/certificate.webp"><br><span
                                                                                                     class="font-weight-bold"></span><span class="text-black-50">Certificate Giveaway</span><span>
                            </span>
                        </div>
                    ...
                    <div class="col-md-5 border-right">
                        <div class="p-3 py-5">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <h4 class="text-right">Issue Certificate:</h4>
                            </div>
                            <form action="printcertificate.jsp" method="post">
                            <div class="row mt-3">
                                <div class="col-md-12">
                                    <label for="exampleDataList" class="form-label"><br>&nbsp;Name of the user</label>
                                ...
                                <div class="col-md-12">
                                    <label for="exampleDataList" class="form-label"><br>&nbsp;Project Name</label>
                                    <input class="form-control" list="datalistOptions" id="exampleDataList" placeholder="Type to search...">
                                    <datalist id="datalistOptions">
                                        <option value="San Francisco">
                                        <option value="New York">
                            ...
                            <div class="mt-5 text-center">
                                <button class="mr-4 btn btn-primary profile-button" type="submit">Publish Certificate </button> 
                            </div>
                        </div>
                    </div>
                    <!--        <div class="col-md-4">
